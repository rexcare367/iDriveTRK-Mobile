...
const PostTripFormSafety = () => {
  ...
  const [formData, setFormData] = useState({
    allFunctioning: postTripFormData?.safety?.allFunctioning ?? true,
    fireExtinguisher: postTripFormData?.safety?.fireExtinguisher || false,
    flagsFlares: postTripFormData?.safety?.flagsFlares || false,
    reflectiveTriangles: postTripFormData?.safety?.reflectiveTriangles || false,
    fireExtinguisherDetails:
      postTripFormData?.safety?.fireExtinguisherDetails || "",
    flagsFlaresDetails: postTripFormData?.safety?.flagsFlaresDetails || "",
    reflectiveTrianglesDetails:
      postTripFormData?.safety?.reflectiveTrianglesDetails || "",
    others: postTripFormData?.safety?.others || "noOtherNotes",
    othersDefectDetails: postTripFormData?.safety?.othersDefectDetails || "",
  });
...
export default PostTripFormSafety;
