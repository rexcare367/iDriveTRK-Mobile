...
const PostTripFormChecklist = () => {
  const dispatch = useDispatch();
  const { postTripFormData } = useSelector((state: any) => state.driver);

  const [formData, setFormData] = useState({
    allFunctioning: postTripFormData?.checklist?.allFunctioning ?? true,
    clutch: postTripFormData?.checklist?.clutch || false,
    parkingBreak: postTripFormData?.checklist?.parkingBreak || false,
    serviceBreak: postTripFormData?.checklist?.serviceBreak || false,
    starter: postTripFormData?.checklist?.starter || false,
    clutchDetails: postTripFormData?.checklist?.clutchDetails || "",
    parkingBreakDetails: postTripFormData?.checklist?.parkingBreakDetails || "",
    serviceBreakDetails: postTripFormData?.checklist?.serviceBreakDetails || "",
    starterDetails: postTripFormData?.checklist?.starterDetails || "",
  });
...
export default PostTripFormChecklist;
